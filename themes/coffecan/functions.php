<?php
/**
 * CoffeCan functions and definitions
 *
...
if ( ! function_exists( 'coffecan_setup' ) ) :
	/**
	 ...
	 */
	function coffecan_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on CoffeCan, use a find and replace
		 * to change 'coffecan' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'coffecan', get_template_directory() . '/languages' );
		...
		add_image_size('coffecan-full-bleed', 2000, 1200, true);
        add_image_size('coffecan-index-img', 800, 450, true);

		// This theme uses wp_nav_menu() in one location.
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Header', 'coffecan' ),
            'social' => esc_html__( 'Social Media Menu', 'coffecan' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'coffecan_custom_background_args', array(
 ...
 */
function coffecan_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'coffecan_content_width', 640 );
}
 ...
 */
function coffecan_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'coffecan' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'coffecan' ),
    ...
    register_sidebar( array(
        ...
        'id'            => 'footer-1',
        'description'   => esc_html__( 'Add footer widgets here.', 'coffecan' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h2 class="widget-title">',
        'after_title'   => '</h2>',
...
add_action( 'widgets_init', 'coffecan_widgets_init' );
...
function coffecan_scripts() {
    ...
    wp_enqueue_script( 'coffecan-functions', get_template_directory_uri() . '/js/functions.js', array('jquery'), '20191705', true );
...
add_action( 'wp_enqueue_scripts', 'coffecan_scripts' );
